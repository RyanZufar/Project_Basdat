...
<head>
  ...
  <style>
    ...
    select {
      ...
      -moz-appearance: none;
      appearance: none;
      background-image: url("data:image/svg+xml;charset=UTF-8,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'%3e%3cpath fill='%23ffffff' d='M7 10l5 5 5-5z'/%3e%3c/svg%3e");
  ...
  <main class="w-full max-w-md p-8 space-y-8">
    ...
    <div class="bg-card-bg backdrop-blur-sm p-8 rounded-2xl card-glow border border-primary/20">
      ...
      <form method="POST" action="{{ route('login') }}" class="space-y-5">
        ...
        <!-- Role -->
        <div>
          <label class="block text-sm mb-1 text-subtle-text-dark">Login sebagai</label>
          <select name="role" class="w-full bg-white/5 text-white px-3 py-2 rounded-md ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:ring-primary">
        ...
        <div class="flex items-center justify-between text-sm">
          <label class="flex items-center text-subtle-text-dark">
            <input type="checkbox" class="mr-2 rounded border-gray-600 text-primary bg-gray-700 focus:ring-primary"> Ingat saya
          </label>
